...
def python_value_from_bracketless_value(bracketless_value):
    ...
    if bracketless_value.type == InterpreterNode.Type.List:
        ...
        return [python_value_from_bracketless_value(elem) for elem in bracketless_list.value]
...
class ParserNode:
    ...
    def is_expression(self):
        if self.type in [
            ParserNode.Type.Identifier, ParserNode.Type.Integer, ParserNode.Type.List,
            ParserNode.Type.Assignment, ParserNode.Type.String, ParserNode.Type.Function,
            ParserNode.Type.Class, ParserNode.Type.Boolean, ParserNode.Type.FunctionCallOrListIndexing,
            ParserNode.Type.PrefixOperation, ParserNode.Type.PostfixOperation, ParserNode.Type.InfixOperation,
            ParserNode.Type.DeclarationAssignment, ParserNode.Type.BuiltinIdentifier, ParserNode.Type.Float,
    ...
    def interpret(self, current_scope):
        ...
        if self.type == ParserNode.Type.PostfixOperation:
            ...
            if op == '++':
                if identifier.type == ParserNode.Type.Identifier and v.type == InterpreterNode.Type.Integer:
        ...
        if self.type == ParserNode.Type.InfixOperation:
            ...
            if op == 'and':
                if lhs.type == InterpreterNode.Type.Boolean and rhs.type == InterpreterNode.Type.Boolean:
                    return InterpreterNode(InterpreterNode.Type.Boolean, lhs.value and rhs.value)
...
class Builtins:
    ...
    builtins["oct"] = InterpreterNode(InterpreterNode.Type.Function, {"type": FunctionType.Internal, "body": oct})
    ...
    builtins["str"] = InterpreterNode(InterpreterNode.Type.Function, {"type": FunctionType.Internal, "body": str})
...
class File:
    ...
    def is_hex(self):
        return self.is_str('0x') and self.content[
